...
Key live evidence is linked from [Agent Service PR #150's retained historical head](https://github.com/c12-ai/BIC-agent-service/blob/62ae7471d703bf85957c12e348b236f3f78cfc05/docs/agent-foundation-refactor-design.md#current-agent-service-assessment) and the live L3 charter at [main](https://github.com/c12-ai/BIC-agent-service/blob/12a84f3238a952f00eb95b24c1943f8303041350/.trellis/spec/backend/L3/charter.md#L19-L35). BIC-meta #327 supersedes #150 as the cross-repo architecture authority.
